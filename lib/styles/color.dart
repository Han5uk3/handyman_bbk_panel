...
class AppColor {
  ...
  static const Color shammaam = Color(0XFFFFF5E6);
  static Color lightGrey100 = Colors.grey.shade100;
  static Color lightGrey500 = Colors.grey.shade500;
  static Color lightwhite = Colors.white70;
  static Color splashBlue = Color(0xFF1A2980);
  static Color lightSplashBlue = Color(0xFF26D0CE);
  static Color lightGrey200 = Colors.grey.shade200;
  static Color lightGrey300 = Colors.grey.shade300;
  static Color lightGrey600 = Colors.grey.shade600;
